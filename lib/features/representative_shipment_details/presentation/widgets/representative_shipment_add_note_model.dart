...
class RepresentativeShipmentAddNoteModel extends StatefulWidget {
  ...
  const RepresentativeShipmentAddNoteModel({
    super.key,
  ...
  @override
  State<RepresentativeShipmentAddNoteModel> createState() =>
      _RepresentativeShipmentAddNoteModelState();
}

class _RepresentativeShipmentAddNoteModelState
    extends State<RepresentativeShipmentAddNoteModel> {
  @override
  void dispose() {
    super.dispose();
  }
