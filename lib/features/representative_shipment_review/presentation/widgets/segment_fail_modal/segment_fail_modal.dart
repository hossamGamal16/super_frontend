...
class _ModalContentState extends State<_ModalContent>
  ...
  Future<void> _onSubmitTap() async {
    // Only validate that feedback is provided
    ...
    widget.onSubmit(_selectedImages, _feedbackController.text);
  }
      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text('وصف المشكلة :', style: AppStyles.styleSemiBold16(context)),
              const SizedBox(width: 4),
              Text(
                '*',
        ...
        Container(
          ...
          child: TextField(
            ...
            decoration: InputDecoration(
              hintText: 'صف المشكلة التي حدثت للشحنة بالتفصيل...',
